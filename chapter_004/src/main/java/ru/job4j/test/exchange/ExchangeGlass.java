package ru.job4j.test.exchange;

import org.xml.sax.SAXException;
import ru.job4j.test.exchange.model.Order;
...
public class ExchangeGlass {
    ...
    public static void main(String[] args) {
        ExchangeGlass glass = new ExchangeGlass();
        glass.fillMaps("E:\\orders.xml");
    }
}
